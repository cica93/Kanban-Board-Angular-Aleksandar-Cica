...
export type TaskStatus = (typeof TASK_STATUSES)[number] | 'TO_DO' | 'IN_PROGRESS';
...
export abstract class AbstractTaskService {
  ...
  abstract put(id: number, version: number, task: TaskForm): Observable<Task | null | undefined>;

  abstract post(task: TaskForm): Observable<Task | null | undefined>;

  abstract delete(id: number, version: number): Observable<Task | null | undefined>;
